...
namespace BookStoreAppMVC.Migrations
{
    ...
    [Migration("20241013123733_updateDatabaseLatest")]
    partial class updateDatabaseLatest
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BookStoreAppMVC.Models.CartItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BookStoreAppMVC.Models.ShoppingCart", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BookStoreAppMVC.Models.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("BookStoreAppMVC.Models.CartItem", b =>
                {
                    b.HasOne("BookStoreAppMVC.Models.Product", "Product")
                        .WithMany()
                        .HasForeignKey("ProductId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("BookStoreAppMVC.Models.ShoppingCart", null)
                        .WithMany("Items")
